...
import AddNew from "../home";

function Home() {
  return(
  <> 
 
 <h1 style={{ fontFamily: "Inter",alignContent:"center" }}>  Home Page</h1> 
  <button  onClick= {AddNew}className="btn btn-primary d-flex justify-content-right position-absolute" style={{ right: '10px', top: '10px', width: 'auto' }}>Add New Images</button>
    </>
);
} 
